...
// dwa razy sout zegnal sie z tym samym tekstem
...
class Biblioteka implements Serializable {
    ...
    public void listaKsiazek() {
        ...
        for (Ksiazka ksiazka : ksiazki) {
            if (ksiazka.isDostepna()) {
                System.out.println("ID: " + ksiazka.getId() + ", Tytuł: " + ksiazka.getTytul() + ", Autor: "
                        + ksiazka.getAutor().pelneImie() + ", Rok wydania: " + ksiazka.getRokWydania());
            }
        }
    }
    ...
    // nowa metoda do wyswietlania historii z konkretnego dnia
    public void wyswietlHistorieZDnia(LocalDate data) {
        System.out.println("Historia z dnia " + data + ":");
        boolean jestHistoria = false;
        for (HistoriaWpisu wpis : historia) {
            if (wpis.getCzasOperacji().toLocalDate().equals(data)) {
                System.out.println(wpis);
                jestHistoria = true;
            }
        }
...
public class Zad4ProgramBiblioteczny {
    public static void main(String[] args) {
        ...
        while (dziala) {
            ...
            System.out.println("13. Pokaż historie z konkretnego dnia");
            ...
            switch (wybor) {
                ...
                case 12:
                    ...
                    break;
                case 13:
                    System.out.println("Podaj date w takim formacie (RRRR-MM-DD): ");
                    String dataHistorii = skaner.nextLine();
                    try {
                        LocalDate data = LocalDate.parse(dataHistorii);
                        biblioteka.wyswietlHistorieZDnia(data);
                    } catch (Exception error) {
                        System.out.println(error + " \nPrawdopodobnie zły format daty..");
                    }
                    break;
            }
        }
